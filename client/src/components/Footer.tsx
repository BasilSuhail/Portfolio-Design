...
export function Footer() {
  ...
  const calendarLinks = content?.contactSettings?.calendarLinks
                ...
                <div className="mb-6 flex gap-3">
                  {calendarLinks?.link15min && (
                    <Button
                      ...
                      asChild
                    >
                      <a href={calendarLinks.link15min} target="_blank" rel="noopener noreferrer">
                  ...
                  {calendarLinks?.link30min && (
                    <Button
                      ...
                      asChild
                    >
                      <a href={calendarLinks.link30min} target="_blank" rel="noopener noreferrer">
                        <Calendar className="h-4 w-4" />
                        30 Min
                      </a>
                    </Button>
